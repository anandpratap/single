	subroutine roeflux(rhol, rhor, ul, ur, pl, pr, f)
		...
		& alpha_3, lambda_1, lambda_2, lambda_3, f1, f2, f3, flux_1, flux_2, flux_3, cl, cr, da
		...
		lambda_3 =  abs(uavg + cavg);
 		    ...
 		    flux_1 = 0.5*((rhol*ul + rhor*ur) - f1);
 		    flux_2 = 0.5*((rhol*ul*ul + pl + rhor*ur*ur + pr) - f2);
 		    flux_3 = 0.5*(ul*hl*rhol + ur*hr*rhor - f3);
